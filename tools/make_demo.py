...
SCENES = [
    {
        ...
        "vo": "This is CATNIP, an autonomous Solana agent built for the Hacka Cat "
              "hackathon. The brief was: build a cat agent that trades all the cat "
              "runners. Everything you are about to see is real output from real "
              "commands. It trades on paper and on devnet, never with real money.",
        "hold": 1.0,
    },
    {
        "kind": "term",
    ...
    },
    {
        ...
        "vo": "Here is the hard part. Trading all the cat runners is a detection problem. "
              ...
              "on this screen, and the agent refuses both, because Catalyst is not a cat and "
              "Bonkai is a dog. DOGWIFCAT literally contains the word cat and is still "
              "rejected, penalised by dog, shiba and inu.",
        "cps": 44,
    },
    {
        "kind": "term",
